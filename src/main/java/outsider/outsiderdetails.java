...
/**
 * Servlet implementation class outsiderdetails
 */
public class outsiderdetails extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public outsiderdetails() {
        super();
...
//		doGet(request, response);
	...
	static void myDatabase(String fn, String ln, int agee, String email,String pass, String gender) {
		...
		try {
			...
			String query = "insert into outsider values(?,?,?,?,?,?)";
